...
export const SongDetails = forwardRef(({isImageShown,videoUrl,opac}:SongDetailsProps,ref:Ref<SongDetailsRef>)=>{      
    ...
    const opacityCSS : {[key:string]:React.CSSProperties}  = {
        container:{
            width:'100%',    
            height:'auto',
            borderRadius:'25px',
    ...
    return (
        <div style={opacityCSS.container}>       
  
        
            <div className='sub-details-container'>
                <div className='video-details-title'>Name</div>
                <div className='video-details-content'>{title}</div>
            </div>
            <div className='sub-details-container'>
                <div className='video-details-title'>Duration</div>
                <div className='video-details-content'>{duration}</div>
