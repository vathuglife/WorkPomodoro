...
import { SongDetailsRef } from '../../Components/SongDetails/SongDetailsRef'
...
export default function MusicPage(){               
    ...
    return(                        
        <div className="main-container">
            <div className='songs-list-title'>Add Songs</div>
                     
            <div id='url-border'>                
                <div id='fa-link'><FaLink size="30"/></div>
                <input id='input-field' type='text'
                    placeholder='Type a YouTube URL here...'
                    onChange={(e)=>handleInput(e)}></input>
            </div>
            
            <div id='details-text'>Details</div>
            ...
            <div id='song-details-pos'>
                {(()=>{
                    if(link.length===0)    {
                        ...
                        return(
                            <SongDetails isImageShown={isImageShown} videoUrl={link} 
                            ref={songDetailsRef}/>
                        )
                    }
                })()}
